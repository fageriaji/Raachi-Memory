...
health routines, tracking money/items lent to others, and managing daily expenses.
...
Features: Dashboard, Reminder, Ledger, Daily Expenses, Activity, Profile, Settings.
...
share. Daily Expenses: Bank/cash/wallet accounts, debit, credit, and
account-to-account transfers. Activity: Timeline. Profile: Name(required), optional profile,
...
ADR-001 Kotlin. ADR-002 Compose. ADR-003 Room. ADR-004 Nunito.
